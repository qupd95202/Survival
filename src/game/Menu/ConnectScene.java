...
//        labels.add(new Label(buttons.get(2).painter().left(), buttons.get(2).painter().top() - 10, "Please Enter Your Pork:", FontLoader.Future(20)));
...
//        editTexts.add(new EditText(buttons.get(2).collider().left() + 10, buttons.get(2).collider().top() + 45, "PORK"));
//
