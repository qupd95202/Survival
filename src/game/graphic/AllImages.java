...
public class AllImages {
    ...
    public static Animation fishGreen=new Animation(new ArrayList<Image>(java.util.List.of(
            ...
            SceneController.getInstance().imageController().tryGetImage(new Path().img().objs().move().fishGreen2()))),Global.MapAreaType.SEA);
    ...
    public static Animation fishPink=new Animation(new ArrayList<Image>(java.util.List.of(
            ...
            SceneController.getInstance().imageController().tryGetImage(new Path().img().objs().move().fishPink2()))),Global.MapAreaType.SEA);
    ...
    public static Animation frog=new Animation(new ArrayList<Image>(java.util.List.of(
            ...
            SceneController.getInstance().imageController().tryGetImage(new Path().img().objs().move().frog2()))),Global.MapAreaType.SEA);
    ...
    public static Animation slimeBlue=new Animation(new ArrayList<Image>(java.util.List.of(
            ...
            SceneController.getInstance().imageController().tryGetImage(new Path().img().objs().move().slimeBlue2()))),Global.MapAreaType.SEA);
